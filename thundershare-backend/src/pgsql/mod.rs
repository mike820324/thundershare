...
use crate::domain::repository::{
    customer::CustomerRepositoryTrait, file_meta::FileMetaRepositoryTrait, used_token::UsedTokenRepositoryTrait
};

use self::{customer::CustomerRepository, file_meta::FileMetaRepository, used_token::UsedTokenRepository};
...
impl ServerRepositories {
    pub fn new(db_pool: DbPool) -> ServerRepositories {
        ...
        let file_meta_repository = FileMetaRepository::new(db_pool);
